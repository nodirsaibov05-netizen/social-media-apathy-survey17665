...
psych_states = {
    "Missing/Very weak connection, High activity & motivation.There are no symptoms of apathy; the use of social media is under complete control, without causing procrastination. Life activity, motivation and interest in real hobbies remain at a very high level.": (0, 32),
    ...
    "Pronounced connection – intensive SM use + clear apathy. Heavy use of social media correlates with overt manifestations of apathy, such as emotional lethargy and lack of goals. Time spent online significantly displaces productive activities and social contacts in the real world.": (59, 71),
    ...
    "Critically strong dependence – serious loss of life interest. This condition indicates a critical dependence on social media and the accompanying deep apathy, in which there is a complete lack of will and motivation. A malfunction requires examination by a specialist and, possibly, psychological intervention.": (86, 100)
}
